    ...
    try:
        while True:
            try:
                ...
                header, questions = dnsparser.unpackDNS(message)
                ...
                try:
                    ...
                    header, questions = dnsparser.unpackDNS(resolverResponse)
                    print(header,questions)
